...
classdef DSC_CLI_APP < handle
    %DSC_CLI_APP
    %   Responsible for providing a command-line user interface (CLI) for
    ...
    properties (Access = private)
        ...
        HelpFileName = './text/CLI__help.txt'
        
        CopyrightFileName = './text/CLI__copyright.txt'
    ...
    methods
        function app = DSC_CLI_APP(varargin)
            %DSC_CLI_APP Construct an instance of this class
            ...
            s = s + 1;
            % Refresh the CLI_Waitbar progress and label
            CLI_Waitbar(s/n,message);
            ...
            % Refresh the CLI_Waitbar progress and label
            CLI_Waitbar(1,'App is now Ready');
        ...
        function runUI(app)
            ...
            app.cleanupObj = onCleanup(@()CLI_Cleanup(app));
